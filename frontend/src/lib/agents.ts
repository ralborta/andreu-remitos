...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    status: "pruebas",
    icon: "ClipboardCheck",
    what: "Proof of Delivery 100% IA: el chofer manda la foto del formulario/producto por WhatsApp. La IA lee el papel (receptor, pedido, destino), conversa si falta algo y deja el caso en cola. Mesa de control confirma o rechaza. Sin menús ni keywords frágiles.",
    flow: [
      "Chofer escribe o manda foto por WhatsApp",
      "IA entiende que es POD (sin heurísticas)",
      "IA escanea el formulario y carga los datos",
