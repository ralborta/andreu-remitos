...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    status: "pruebas",
    icon: "ClipboardCheck",
    what: "Proof of Delivery: el chofer manda por WhatsApp la foto del formulario de entrega y/o del producto. La IA lee el papel (receptor, pedido, destino), deja el caso en cola y mesa de control confirma o rechaza. No reemplaza al remito de carga.",
    flow: [
      "Chofer escribe “entregué” / “POD” por WhatsApp",
      "Agente pide foto del formulario + evidencia",
      "IA escanea y carga receptor / pedido / destino",
      "Si falta el receptor, lo pide por texto",
      "Caso pendiente en el panel (POD-…)",
      "Backoffice confirma o rechaza · aviso al chofer",
    ],
    benefits: [
    ...
    channels: ["WhatsApp", "Backoffice", "Agente Viajes"],
    kpis: [
