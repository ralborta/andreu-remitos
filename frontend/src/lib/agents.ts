...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    status: "pruebas",
    icon: "Route",
    what: "Recibe solicitudes de transporte, valida datos, asigna chofer/unidad y lleva el viaje por estados en Andreu. Listo para sincronizar con un TMS cuando se active el conector (hoy opera solo).",
    flow: [
      "Alta de viaje (cliente, origen, destino, carga)",
      "Confirmación interna",
      "Asignación de chofer y unidad",
      "Seguimiento por estados",
      "Enganche opcional a remitos / destinos",
      "Sync TMS (cuando esté habilitado)",
    ],
    benefits: [
      "Operación sin depender del TMS",
      "Código de viaje trazable",
      "Preparación para integración externa",
    ],
    channels: ["Plataforma", "WhatsApp", "TMS"],
    kpis: [
      { label: "Viajes en gestión", value: "—", trend: "" },
      { label: "Sin TMS (modo local)", value: "ON", trend: "" },
      { label: "Conector TMS", value: "Stub", trend: "" },
    ],
  },
  {
    id: 3,
