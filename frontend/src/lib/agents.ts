...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    status: "pruebas",
    icon: "ClipboardCheck",
    what: "Proof of Delivery: el chofer avisa por WhatsApp a quién entregó y manda la foto de prueba (firma, sello o mercadería). Queda en cola para que mesa de control confirme o rechace. No reemplaza al remito de carga.",
    flow: [
      "Chofer escribe “entregué” / “POD” por WhatsApp",
      "Agente pide nombre de quien recibió",
      "Chofer envía foto de la prueba",
      "Caso pendiente en el panel (POD-…)",
      "Backoffice confirma o rechaza",
      "Aviso al chofer por WhatsApp",
    ],
    benefits: [
