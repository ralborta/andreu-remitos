...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    collaboratesWith: ["eta", "incidencias", "pod", "tracking"],
  },
  {
    id: 10,
    slug: "tracking",
    name: "SOL Tracking Express",
    short: "Tracking Express",
    subtitle: "Seguimiento del viaje desde el celular del chofer (webapp, sin instalar app)",
    status: "pruebas",
    icon: "Navigation",
    what: "Genera un enlace seguro temporal, lo envía por WhatsApp y recibe posiciones del navegador del chofer mientras la pantalla está activa. Torre de control con última ubicación, antigüedad real, incidencias y POD. No garantiza seguimiento en segundo plano.",
    flow: [
    ...
    benefits: [
      "Sin app nativa ni GPS hardware",
      "Antigüedad real de la señal",
      "Enganche con Viajes, Incidencias y POD",
    ],
    channels: ["Webapp PWA", "WhatsApp", "Browser Geolocation", "Mesa web"],
    kpis: [
      { label: "Fuente", value: "Navegador", trend: "" },
      { label: "Modo", value: "Piloto", trend: "" },
      { label: "Segundo plano", value: "No garantizado", trend: "" },
    ],
    collaboratesWith: ["viajes", "incidencias", "pod", "eta"],
  },
  {
    id: 2,
    slug: "remitos",
  ...
  },
  {
    id: 7,
    slug: "pod",
    name: "Evidencias de Transporte",
    short: "POP/POD",
    subtitle: "Proof of Pickup y Proof of Delivery — cadena de custodia por WhatsApp",
    status: "operativo",
    icon: "ClipboardCheck",
    what: "Agente unificado de evidencias físicas: POP (retiro en origen) y POD (entrega en destino). WhatsApp + Document AI + mesa de control. Comparación POP vs POD y milestones en cada viaje.",
    flow: [
    ...
    benefits: [
      "Cadena de custodia origen → destino",
      "Detección de diferencias de carga",
      "Un solo agente, dos eventos",
      "Compatible con Remitos y Tracking",
    ],
    channels: ["WhatsApp", "Document AI", "Backoffice", "Tracking Express", "Agente Viajes"],
    kpis: [
      { label: "POP pendientes", value: "—", trend: "" },
      { label: "POD pendientes", value: "—", trend: "" },
      { label: "Con diferencias", value: "—", trend: "" },
    ],
    collaboratesWith: ["viajes", "destinos", "incidencias", "tracking", "remitos"],
  },
  {
    id: 8,
    slug: "reclamos",
