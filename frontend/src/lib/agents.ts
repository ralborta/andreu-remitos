...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    status: "beta",
    icon: "TriangleAlert",
    what: "Dos caminos: (1) el agente consulta al chofer por WhatsApp cuando hay un evento en ruta; (2) el chofer reporta solo (pinchazo, demora, control, mecánico…). La IA clasifica tipo y criticidad, abre el caso y operaciones lo toma o cierra. Las demoras de Destinos también quedan registradas acá.",
    flow: [
      "Evento detectado o chofer escribe por WhatsApp",
      "Agente pide la causa (si hace falta)",
      "Chofer explica qué pasó",
      "IA clasifica tipo y criticidad",
      "Caso abierto en el panel (INC-…)",
      "Operaciones toma o resuelve con aviso al chofer",
    ],
    benefits: [
      "Reacción más rápida",
      "Trazabilidad de incidencias",
      "Chofer puede reportar sin esperar",
    ],
