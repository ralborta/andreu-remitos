/** Schema Document AI — remito Beraldi (16 campos). */
  ...
  entityTypes: [
    {
      ...
      properties: [
        ...
        { name: "km_inicial", valueType: "string", occurrenceType: "OPTIONAL_ONCE" },
        { name: "km_final", valueType: "string", occurrenceType: "OPTIONAL_ONCE" },
      ],
    },
  ],
};
