...
export const RENDICION_MESA_COLUMNS = [
  ...
  { key: "nro_viaje_delfos", header: "Nº viaje Delfos", width: 120 },
  { key: "viaje_documento", header: "Viaje en documento", width: 120 },
  { key: "punto_venta", header: "Punto venta", width: 96 },
  { key: "nro_t", header: "Nº T", width: 96 },
...
export const RENDICION_ERP_COLUMNS = [
  ...
  { key: "nro_viaje_delfos", header: "NroViajeDelfos", width: 120 },
  { key: "viaje_documento", header: "ViajeDocumento", width: 120 },
  { key: "punto_venta", header: "PuntoVenta", width: 96 },
  { key: "nro_t", header: "NroT", width: 96 },
  { key: "iva_pct", header: "IvaPct", width: 72 },
  { key: "rae", header: "RAE", width: 56 },
...
function mapRow(row) {
  ...
  return {
    ...
    viaje: row.nro_viaje_delfos || row.viaje_ref || row.remito_ref || "",
    nro_viaje_delfos: row.nro_viaje_delfos || "",
    viaje_documento: row.viaje_documento || "",
