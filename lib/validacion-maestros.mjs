...
const CAMPOS_UNIDAD_TENANT = {
  ...
  mye: [
    { label: "Camión / chasis", keys: ["chasis", "patente_chasis"], tipo: "tractor" },
    { label: "Acoplado", keys: ["acoplado", "semi", "patente_acoplado"], tipo: "acoplado" },
  ],
  beraldi: [
...
export function validarDestinoConMaestros(datos, tenant, localidades) {
  ...
  if ((tenant === "tsb" || tenant === "mye") && loc.tipo === "origen") {
    return {
      ok: false,
      localidad: loc,
