        ...
        messages: [
          {
            role: "system",
            content:
              "Clasificás si un chofer quiere registrar retiro de carga en origen (POP). JSON only.",
          },
          {
            role: "user",
            content: `Mensaje: """${t}"""
POP si: cargué, retiré, pickup, mercadería en camión, foto de carga en origen.
NO POP si: entrega/POD, gasto, incidencia, reclamo.
