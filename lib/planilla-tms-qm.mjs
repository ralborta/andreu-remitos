...
export function tipoViajeTmsQm(tipoViaje) {
  return TIPO_VIAJE_TMS[tipoViaje] ?? String(tipoViaje ?? "").toLowerCase();
}
...
export function remitoAFilasTmsQm(remito, ctx) {
  ...
  const horaCarga = horaSlot(hor.carga_entrada) || horaSlot(hor.carga_salida);
  const horaDescarga = horaSumarHoras(horaCarga, 3);
