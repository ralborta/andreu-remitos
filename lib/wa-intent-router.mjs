...
Intents:
- "viaje": pide transporte/flete, o aporta datos de un viaje (origen, destino, toneladas, tipo de carga, fecha/hora), aunque sea informal ("necesito ir a Córdoba con carga", "20 tn soja mañana")
...
- Si no es chofer y no está claro → "desconocido" o "chat" y armá mensaje corto (rioplatense) preguntando viaje o reclamo.
