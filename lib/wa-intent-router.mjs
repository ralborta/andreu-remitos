...
Contexto:
- es_chofer_remitos: ${esChoferRemitos ? "sí" : "no"} (si sí: remitos + rendición de gastos; si no: es CLIENTE)
...
Intents:
- "rendicion": gastos menores del viaje — nafta, peajes, tickets, facturas, llantas, aceite, remolque, auxilio mecánico, arreglos del vehículo, "rendición". SOLO si es_chofer_remitos=sí.
...
Reglas:
- Si es_chofer_remitos=no: NUNCA elijas "rendicion" ni "remito". Si el cliente habla de peaje/nafta/gasto, tratá como chat/desconocido (no es chofer) o reclamo/viaje según corresponda. En mensaje de ayuda NO menciones rendición.
- Si es_chofer_remitos=sí y habla de gasto/comprobante/nafta/peaje/taller → "rendicion".
