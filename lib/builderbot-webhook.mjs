...
export function mensajeAudioNoEntendido(texto, remito) {
  ...
  const pref = corto ? `Escuché: «${corto}»\n\n` : "";
  if (remito?.estado === "bloqueado") {
    return `${pref}No identifiqué qué hora corregir. Probá: *salida carga 19:44* o *entrada carga 08:30*.`;
  }
  return `${pref}No identifiqué qué corregir. Probá: *Peso 29762* o *Semi ABC123*.`;
}
