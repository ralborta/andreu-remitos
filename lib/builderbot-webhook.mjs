...
export function normalizeBuilderBotPayload(body) {
  ...
  const urlTempFile = isAbsoluteUrl(data.urlTempFile) ? String(data.urlTempFile) : null;
  ...
  if ((isMediaEvent || isVoiceNote || isAudioEvent) && (attachmentList.length > 0 || urlTempFile)) {
    message = "";
  }
