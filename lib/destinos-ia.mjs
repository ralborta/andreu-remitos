...
- Si el chofer habla de *remito*, foto de remito, guía o quiere enviarlo → intent "chat", mensaje=null (otro agente lo atiende). NUNCA digas que no puede enviar el remito por la ETA ni inventes reglas de "cuando llegues a destino".`
