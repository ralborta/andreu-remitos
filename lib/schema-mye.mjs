/** Schema Document AI — remitos MyESA / M&E (mismos campos que TSB). */
export const MYE_DOCUMENT_SCHEMA = {
  displayName: "Remito MyESA",
  description: "Campos remito MyESA (M&E) — mismo set que guía TSB",
  entityTypes: [
    {
